...
<!--                                        <img class="blog__photo blog__photo--active" src="../images/blog/11.jpg" alt=""></a>-->
                                        ...
                                        <div class="blogs__blogs">
                                            <div class="blogs__item">
                                                ...
                                                <div class="blogs__content">
                                                    <a class="blogs__title" href="arts.php"><p>Lorem ipsum dolor sit amet, consectetur adipiscing</p></a>
                                            ...
                                            <div class="blogs__item">
                                                ...
                                                <div class="blogs__content">
                                                    <a class="blogs__title" href="arts.php"><p>Consectetur adipiscing elit, sed do eiusmod tempor</p></a>
                                                    <div class="blogs__date">
                                                        Jan 9, 2016
                                                    </div>
                                                </div>
                                            ...
                                            <div class="blogs__item">
                                                ...
                                                <div class="blogs__content">
                                                    <a class="blogs__title" href="arts.php"><p>sed do eiusmod tempor
                            ...
                            <a href="admin.php" class="back__button" id="backClick">add news</a>
                        </div>
                    </div>
